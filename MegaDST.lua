...
DST:addParam("Delay", "Chat Delay",SCRIPT_PARAM_SLICE, 150, 30, 700, 5)
DST:addParam("CDelay", "Delay Between GJs",SCRIPT_PARAM_SLICE, 20, 10, 100, 0)
